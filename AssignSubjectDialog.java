...
public class AssignSubjectDialog extends JDialog implements ActionListener {
	...
	private AssignSubjectDialog(Faculty f) {
		...
		JLabel lblCourceName = new JLabel("Program Name  :");
		...
		positioncombo.setModel(new DefaultComboBoxModel<String>(new String[] {"---Select Position---", "Full Time", "Part Time"}));
		...
		assignsubjectbutton = new JButton("Assign Course");
