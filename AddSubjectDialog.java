...
public class AddSubjectDialog extends JDialog implements ActionListener
{
	...
	public AddSubjectDialog(String courceCode,int sem,JTable datatable) {
		...
		JLabel lblSubjectName = new JLabel("Course Name");
		...
		courcetypecombo.setModel(new DefaultComboBoxModel<String>(new String[] {"---select---", "Core", "Audit Course"}));
		...
		contentPanel.add(headerlabel);
		 ...
		 addsubject = new JButton("Add Course");
